...
Ranking metrics are particularly useful when you are only interested in the top $n$ scores. This is because the top $n$ scores only depen on the rank of the scores not the scale. If the scale is not important they metric does not need to depend on it. 
